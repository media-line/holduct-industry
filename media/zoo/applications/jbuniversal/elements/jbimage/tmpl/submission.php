...
<div class="<?php echo $this->identifier; ?> jbimage-submission">
    <div class="image-select">
        <div class="upload">
            <input type="text" name="<?php echo $this->getControlName('filename'); ?>" class="filename" readonly="readonly" />
            <div class="button-container">
                <button class="button-grey search" type="button"><?php echo JText::_('Select'); ?></button>
