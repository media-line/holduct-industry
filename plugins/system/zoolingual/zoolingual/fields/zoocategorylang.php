...
*/
	...
	if (count($languages)) foreach ($languages as $lang) {
		...
		$line = '<span class="inputlang">';
		$line .= '<input type="text" name="'.$control_name.'['.$lang['tag'].']" value=\''.$value->get($lang['tag']).'\' />'; // using sinle quotes to allow users using them in the output
